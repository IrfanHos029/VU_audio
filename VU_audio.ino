...
//volCountLeft  = 0;      // Frame counter for storing past volume data
//volCountRight  = 0;      // Frame counter for storing past volume data
int
  reading,
...
/*
    ...
    vu14(); // ripple up & down
     ...
     vu12(); // juggle with glitter
      break;} 

                  case 15:
     buttonPushCounter==15; {
     vu9(); // stream with glitter
      break;} 
...
/*void All2()
{
  ...
  EVERY_N_SECONDS( 15 ) { nextPattern2(); } // change patterns periodically
}*/
